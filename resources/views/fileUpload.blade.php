...
$teee = Storage::disk('local');
//$disk = Storage::disk('s3');
$disk = Storage::disk('wasabi');


//if (Storage::disk('wasabi')->missing('file.jpg')) {
    // ...
//}
...
<div class="container">
 ...
 <div class="card-header" style=" font-size: 21px; line-height: 1.3; ">Загрузка файла на облако <br>(макс размер 100 МБ)</div><br>
...
<div class="card-body">
 ...
 <br><div class="alert alert-success" style="display:none;"><textarea class="form-control" id="logs" rows="4" style="width: 261px;"></textarea></div>
 </div>
