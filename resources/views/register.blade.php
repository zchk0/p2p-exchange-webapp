	...
	<div class="container" style="padding: 55px 0 50px;">
		<div class="panel panel-primary">
			<div class="panel-heading"
				style="padding: 15px 20px;background-color: #5a5a5a;border-color: #6b6c6c;text-align: center;margin-bottom: 5px;">
				Регистрация аккаунта</div>
			<form class="panel-body" method="POST" action="{{ route('user.register') }}">
				...
				<input class="form-control" id="password" name="password2" type="password" value=""
				...
				<div style="text-align: right;">
					<button class="btn btn-primary" type="submit" name="sendMe" value="1"
						style=" padding: 8px 35px;font-size: 15px;">Регистрация</button>
				</div>
			</form>
		</div>
		<p id="nav">
