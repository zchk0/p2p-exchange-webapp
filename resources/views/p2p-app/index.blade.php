...
<style>
    ...
    <div><div class="_t">USD (ЦБ <?php echo date("d.m.Y") ?>):</div><div class="_v" title="Курс ЦБ"><?php echo $mclist['eur']['cbprice'] ?? 0; ?> <i>EUR</i></div><div class="_v" title="Курс ЦБ РФ"><?php echo $mclist['rub']['cbprice'] ?? 0; ?> <i>RUB</i></div><div class="_v" title="Курс ЦБ"><?php echo $mclist['uah']['cbprice'] ?? 0; ?> <i>UAH</i></div><div class="_v" title="Курс ЦБ РК"><?php echo $mclist['kzt']['cbprice'] ?? 0; ?> <i>KZT</i></div><div class="_v" title="Курс ЦБ"><?php echo $mclist['try']['cbprice'] ?? 0; ?> <i>TRY</i></div>
    </div>
    </div></div>
    <nav>
		...
		<div class="panel panel-primary" style="border-color: #b9b9b9;">
			...
			<div class="panel-footer">
				<div class="text-center">
					<button class="btn btn-primary" id="load" data-loading-text="Загружаем..." style="padding: 7px 20px;">Загрузить</button> <!-- <button class="btn btn-primary" id="load" data-loading-text="Загружаем...">Лучший спред</button> -->
				</div>
			</div>
		</div>
...
<script>
    ...
    var options = {
        ...
        'RUB': ['Все методы','Advcash','Банковский перевод','HomeCreditBank','ОТП Банк','Payeer','QIWI','Райффайзенбанк','Росбанк','Тинькофф Банк','ЮMoney','Юникредит банк','СБП (Система быстрых платежей)','МТС-Банк','Сбербанк'],
        'RUBv': ['all-methods','Advcash','BANK','HomeCreditBank','OTPBankRussia','Payeer','QIWI','RaiffeisenBank','RosBank','Tinkoff','YandexMoneyNew','UniCreditRussia','SBP','MTSBank','Sberbank'],
